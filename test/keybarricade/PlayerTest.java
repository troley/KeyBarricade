...
public class PlayerTest {
    ...
    public void testMove3() {
        ...
        Player p = new Player(0, 0);
        if (!p.checkCollision(f, KeyEvent.VK_RIGHT)) { // should block nothing, player wants to move onto a floor tile
            p.move(x, y);
        }
    ...
    public void testMove4() {
        ...
        Player p = new Player(0, 0);
        if (!p.checkCollision(k, KeyEvent.VK_RIGHT)) { // should block nothing, player wants to move onto a key tile
            p.move(x, y);
        }
    ...
    public void testMove5() {
        ...
        Player p = new Player(0, 0);
        if (!p.checkCollision(f, KeyEvent.VK_RIGHT)) { // should block nothing, player wants to move onto a finish tile
            p.move(x, y);
        }
